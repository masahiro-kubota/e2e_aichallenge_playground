...
def plot_results(
    mcap_path, vel_t, vel_v, status_t, status_v, u_interp, results, mode_title="Identification"
):
    ...
    try:
        ...
        fig = make_subplots(
            ...
            subplot_titles=(
                "Vehicle Velocity",
                f"Steering Angle Response ({mode_title})",
                "Model Error",
            ),
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=y_fopdt,
                mode="lines",
                name=f"FOPDT (RMSE={rmse_fopdt:.4f})",
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=y_sopdt,
                mode="lines",
                name=f"SOPDT (RMSE={rmse_sopdt:.4f})",
    ...
    fig, (ax1, ax2, ax3) = plt.subplots(
        3, 1, figsize=(10, 10), sharex=True, gridspec_kw={"height_ratios": [1, 3, 1.5]}
    )
...
def main():
    ...
    if args.command == "train":
        ...
        plot_results(
            mcap_path, vel_t, vel_v, status_t, status_v, u_interp, results, mode_title="Training"
        )
        ...
        print_results(results)
        plot_results(
            mcap_path, vel_t, vel_v, status_t, status_v, u_interp, results, mode_title="Evaluation"
        )
