...
def test_overlap_collision():
    ...
    print(
        f"Profile 1 (Right): Start={p1.s_start_action}, End={p1.s_end_action}, Target={p1.target_lat:.2f} (Sign={p1.sign})"
    )
    print(
        f"Profile 2 (Left): Start={p2.s_start_action}, End={p2.s_end_action}, Target={p2.target_lat:.2f} (Sign={p2.sign})"
    )
