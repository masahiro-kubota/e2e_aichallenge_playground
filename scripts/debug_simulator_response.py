...
def main():
    ...
    for i in range(steps):
        ...
        # Retrieve state
        current_steering = node._current_state.actual_steering  # noqa: SLF001
        internal_rate = node._current_state.steer_rate_internal  # noqa: SLF001

        print(
            f"{t:5.2f}   | {target_steering:6.3f}       | {current_steering:6.3f}      | {internal_rate:6.3f}"
        )
