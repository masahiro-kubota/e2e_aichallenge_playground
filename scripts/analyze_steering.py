...
with open(mcap_path, "rb") as f:
    ...
    if steering_angles:
        ...
        print(f"Min value:  {np.min(steering_arr):.6f} rad ({np.degrees(np.min(steering_arr)):.3f}°)")
        print(f"Max value:  {np.max(steering_arr):.6f} rad ({np.degrees(np.max(steering_arr)):.3f}°)")
        print(f"Mean value: {np.mean(steering_arr):.6f} rad ({np.degrees(np.mean(steering_arr)):.3f}°)")
        print(f"Std dev:    {np.std(steering_arr):.6f} rad ({np.degrees(np.std(steering_arr)):.3f}°)")
        print(f"Range:      {np.ptp(steering_arr):.6f} rad ({np.degrees(np.ptp(steering_arr)):.3f}°)")
    ...
    if control_angles:
        ...
        print(f"Mean value: {np.mean(control_arr):.6f} rad ({np.degrees(np.mean(control_arr)):.3f}°)")
