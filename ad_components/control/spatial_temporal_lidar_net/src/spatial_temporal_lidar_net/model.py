...
class SpatialTemporalLidarNet(nn.Module):
    def __init__(self, _input_dim=1080, _num_frames=20, output_dim=1):
        super().__init__()
        ...
        self.conv1 = nn.Conv2d(
            in_channels=1, out_channels=16, kernel_size=(3, 5), stride=(1, 2), padding=(1, 2)
        )
        self.bn1 = nn.BatchNorm2d(16)

        # Conv2
        self.conv2 = nn.Conv2d(
            in_channels=16, out_channels=32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)
        )
        self.bn2 = nn.BatchNorm2d(32)

        # Conv3
        self.conv3 = nn.Conv2d(
            in_channels=32, out_channels=64, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)
        )
        ...
        self.conv4 = nn.Conv2d(
            in_channels=64, out_channels=128, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)
        )
