...
from core.data import VehicleParameters, VehicleState, TopicSlot
...
def test_steering_response_integration():
    ...
    sim_config = SimulatorConfig(
        ...
        map_path=Path("experiment/assets/lanelet2_map.osm"), # Dummy path, check not performed if map not used logic
    ...
    assert abs(node._current_state.steer_rate_internal) < 0.1, "Internal rate should settle to zero at steady state"
