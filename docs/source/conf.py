...
sys.path.insert(0, os.path.abspath("../../simulators/simulator_kinematic/src"))
sys.path.insert(0, os.path.abspath("../../simulators/simulator_dynamic/src"))
sys.path.insert(0, os.path.abspath("../../experiment/runner/src"))
